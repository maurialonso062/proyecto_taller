                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="cliente_apellido" class="form-control" disabled>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="cliente_ruc" class="form-control" disabled>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="cliente_telefono" class="form-control" disabled>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="cliente_direc" class="form-control" disabled>
