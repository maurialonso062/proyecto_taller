...
function listar(){
    ...
    .done(function(resultado){
        var lista = "";
        for(rs of resultado){
            lista = lista + "<tr class=\"item-list\" onclick=\"seleccionNacionalidad("+rs.id+",'"+rs.nac_descri+"');\">";
                lista = lista + "<td>";
                lista = lista + rs.id;
                lista = lista +"</td>";
                lista = lista + "<td>";
                lista = lista + rs.nac_descri;
                lista = lista +"</td>";
            lista = lista + "</tr>";
        }
...
function seleccionNacionalidad(codigo, nac_descri){
    $("#txtCodigo").val(codigo);
