        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Tipo Items <small>CRUD de Tipo Items</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="tipo_descripcion" class="form-control" disabled>
                                 ...
                                 <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="tipo_objeto" class="form-control" disabled>
